      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            Sobre a <span className="text-blue-900">Master Equipamentos</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <p className="text-gray-600">Equipamentos de última geração</p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-blue-900 rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-gray-600">Instalação profissional e garantida</p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-blue-900 rounded-full mt-2 flex-shrink-0"></div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="bg-gradient-to-br from-blue-900 to-gray-800 rounded-2xl p-8 text-white">
          ...
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <stat.icon className="h-8 w-8 text-blue-900 mx-auto mb-4" />
