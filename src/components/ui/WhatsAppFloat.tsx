...
const WhatsAppFloat = () => {
  ...
  return (
    <button
      onClick={handleClick}
      className={cn(
        'fixed bottom-6 right-6 z-50 flex items-center justify-center w-16 h-16 bg-green-600 hover:bg-green-700 rounded-full shadow-2xl transition-all duration-300 hover:scale-110',
